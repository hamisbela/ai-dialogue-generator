      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Have questions about our AI Dialogue Generator? Get in touch!
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">contact@aidialoguegenerator.com</p>
              </Card>
            </div>
            ...
            <div className="gradient-border">
              <Card className="p-8 space-y-4">
                ...
                <p className="text-gray-600">@AIDialogueGen</p>
              </Card>
            </div>
